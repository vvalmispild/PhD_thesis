...
set autoscale
#set title "A_{max}=4.44, {/Symbol w}=1, FWHM=1"
...
plot "./1/Pulse_circ.dat" u 2:3 title "{/Symbol f}_y=0" w l ls 1 lw 5, \
"./2/Pulse_circ.dat" u 2:3 title "{/Symbol f}_y={/Symbol p}/6" w l ls 2 lw 5, \
"./3/Pulse_circ.dat" u 2:3 title "{/Symbol f}_y={/Symbol p}/4" w l ls 10 lw 5, \
"./4/Pulse_circ.dat" u 2:3 title "{/Symbol f}_y={/Symbol p}/3" w l ls 4 lw 5, \
