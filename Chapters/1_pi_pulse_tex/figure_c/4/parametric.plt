...
plot "./p_1.dat" u 2:3 title "{/Symbol w}=1.0" w l lw 3, \
"./p_2.dat" u 2:3 title "{/Symbol w}=2.0" w l lw 3, \
"./p_3.dat" u 2:3 title "{/Symbol w}=3.0" w l lw 3, \
"./p_4.dat" u 2:3 title "{/Symbol w}=4.0" w l lw 3, \
